def create_table() -> None:
    ...
    create_u2a_session_agent_config_table()
    ...
    create_a2a_session_short_term_memory_table()
    ...
    create_a2a_session_side_msg_table()