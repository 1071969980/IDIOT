...
CREATE INDEX idx_u2a_agent_short_term_memory_session_id ON u2a_agent_short_term_memory (session_id);
CREATE INDEX idx_u2a_agent_short_term_memory_user_id ON u2a_agent_short_term_memory (user_id);
CREATE INDEX idx_u2a_agent_short_term_memory_session_task_id ON u2a_agent_short_term_memory (session_task_id);
