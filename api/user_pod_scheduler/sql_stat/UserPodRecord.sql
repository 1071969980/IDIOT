...
--
CREATE UNIQUE INDEX IF NOT EXISTS idx_user_pod_records_user_id ON user_pod_records (user_id);
--
...
-- InsertRecord
INSERT INTO user_pod_records (user_id, status, pod_name, namespace)
VALUES (:user_id, :status, :pod_name, :namespace)
RETURNING id;
